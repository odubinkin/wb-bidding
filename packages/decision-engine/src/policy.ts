...
export function validateDecisionPolicy(policy: DecisionPolicy): void {
  const positiveIntegers = [
    ...
    policy.maxConcurrentExperimentsPerAccount,
    policy.maxConcurrentExperimentsPerCampaign,
    policy.minBidObservationDays,
    policy.minExplorationFullDays,
...
export function initialObserveOnlyPolicy(): DecisionPolicy {
  return Object.freeze({
    ...
    maxConcurrentExperimentsPerAccount: 10,
    maxConcurrentExperimentsPerCampaign: 1,
