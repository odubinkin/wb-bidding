...
- [справочник реализации](docs/implementation-reference.md) — подробный порядок работы runtime,
  API, синхронизации, WB-клиента, записи, mock, эксплуатации и поставки;
