...
The final data-model document at f2ac30cf6432 provides one canonical implementation-grounded reference for every current table and stored column.
...
- PASS: implementation commit f2ac30cf6432 is scoped to docs/data-model.md and follows the earlier exhaustive-reference commit 9a87a78104f7.
