...
result_summary: "verified-202608030819-KAS2Z3"
status: "DONE"
priority: "high"
owner: "CODER"
revision: 17
...
verification:
  state: "ok"
  updated_at: "2026-08-03T08:40:07.731Z"
  updated_by: "CODER"
  note: "verified-202608030819-KAS2Z3"
  attempts: 0
quality_review:
  state: "pass"
...
commit:
  hash: "321451f006558cb757375aea95b37679a85f905d"
  message: "🚧 KAS2Z3 task: record P1 quality review"
comments:
  -
    author: "CODER"
  ...
  -
    author: "CODER"
    body: "Verified: verified-202608030819-KAS2Z3. Guided shortcut recorded verification and is closing the direct task with traceable commit metadata."
events:
  -
    type: "status"
  ...
  -
    type: "verify"
    at: "2026-08-03T08:40:07.731Z"
    author: "CODER"
    state: "ok"
    note: "verified-202608030819-KAS2Z3"
  -
    type: "status"
    at: "2026-08-03T08:40:07.942Z"
    author: "CODER"
    from: "DOING"
    to: "DONE"
    note: "Verified: verified-202608030819-KAS2Z3. Guided shortcut recorded verification and is closing the direct task with traceable commit metadata."
doc_version: 3
doc_updated_at: "2026-08-03T08:40:07.943Z"
...
sections:
  ...
  Verification: |-
    ...
    ### 2026-08-03T08:40:07.731Z — VERIFY — ok
    ...
    VerifyStepsRef: doc_version=3, doc_updated_at=2026-08-03T08:39:29.947Z, excerpt_hash=sha256:6daf5f13faa8938e02ca11221f0c3f2b0a2b32ae2441568a6743b55621fe7f8e
    ...
    - operator_action: run_exact_argv
    - can_execute_now: true
    - safe_command: agentplane task complete 202608030819-KAS2Z3 --result verified-202608030819-KAS2Z3 --commit 321451f006558cb757375aea95b37679a85f905d
    - diagnostic_command: none
    - source_of_truth: route=task_next_action diagnostic=task_next_action remote=not_checked
    - freshness: route=computed_local remote=remote_skipped
    - repeat_allowed: true
...
extensions:
  implementation_commit:
    hash: "2a585df7a57419e582ebcb985d20c6719a2fb5f3"
    message: "🚧 KAS2Z3 task: add P1 lifecycle and pagination indexes"
id_source: "generated"
---
## Summary
